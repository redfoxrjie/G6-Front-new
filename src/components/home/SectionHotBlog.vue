...
const cards = ref([
  {
    ...
    imageSrc: 'https://tibamef2e.com/cid101/g6/images/japan_yufuin-kinrinko.jpg'
  },
  {
    title: '東京粉色自由行| 沉浸式賞櫻與參拜之旅',
    content: '春天的東京，粉色花海美不勝收。本次自由行深入東京的隱秘角落，賞櫻並體驗日本的傳統文化。參拜歷史悠久的淺草寺，感受古老神社的神聖氛圍...',
    imageSrc: 'https://tibamef2e.com/cid101/g6/images/japan_asakusa_street.jpg'
  },
  {
    title: '濟州島fun輕鬆|走進神話般的壯麗美景',
    content: '從濟州的火山岩石海岸線到神秘的瀑布，每一處都讓人感覺如同步入了神話世界。遊覽青翠的山巒，探索隱藏在深林中的寺廟，每一刻都讓人心曠神怡...',
    imageSrc: 'https://tibamef2e.com/cid101/g6/images/korea_jeju-island.jpg'
  }
]);
